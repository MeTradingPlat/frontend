...
/**
 * Linea de tendencia dibujada a mano -- herramienta basica (ver
 * ChartDrawingManager), sin puntos de control ni edicion, solo trazar y
 * borrar. Recalcula pixeles en cada render desde tiempo/precio (no los
 * guarda) para quedar anclada al hacer pan/zoom.
 */
export class TrendLinePrimitive implements ISeriesPrimitive<Time> {
  ...
  constructor(readonly p1: TrendLinePoint, readonly p2: TrendLinePoint) {}
